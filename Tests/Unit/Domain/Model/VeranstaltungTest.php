...
/**
 * Test case for class \ArbkomEKvW\Evangtermine\Domain\Model\Veranstaltung.
 *
 ...
 */
class VeranstaltungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \ArbkomEKvW\Evangtermine\Domain\Model\Veranstaltung
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \ArbkomEKvW\Evangtermine\Domain\Model\Veranstaltung();
	}
