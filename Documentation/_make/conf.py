# -*- coding: utf-8 -*-
#
# Evangelische Termine documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 14 Jul 2015 09:51:04 +0200.
#
...
project = u'Evangelische Termine'
copyright = u'2015, Christoph Roth'
...
htmlhelp_basename = 'evangterminedoc'
...
latex_documents = [
    ('Index', 'evangtermine.tex', u'Evangelische Termine',
     u'Christoph Roth', 'manual'),
]
...
pdf_documents = [
    ('Index', 'evangtermine', u'Evangelische Termine',
     u'Christoph Roth'),
]
...
texinfo_documents = [
    ('Index', 'evangtermine', u'Evangelische Termine',
     u'Christoph Roth', 'Evangelische Termine', 'One line description of project.',
     'Miscellaneous'),
]
