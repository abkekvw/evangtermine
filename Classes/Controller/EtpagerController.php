...
class EtpagerController extends \TYPO3\CMS\Fluid\Core\Widget\AbstractWidgetController {
	...
	public function indexAction() {
		...
		$pg['pages'] =  ceil( $totalItems / intval($this->widgetConfiguration['itemsPerPage']) ); 
		$pg['current'] = isset($this->widgetConfiguration['currentPage']) ? $this->widgetConfiguration['currentPage'] : 0;
		$this->view->assign('pg', $pg);
		$this->view->assign('conf', $this->widgetConfiguration);
	}
